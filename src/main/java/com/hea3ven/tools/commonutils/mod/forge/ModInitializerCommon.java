package com.hea3ven.tools.commonutils.mod.forge;
...
import com.hea3ven.tools.commonutils.mod.InfoEnchantment;
...
public abstract class ModInitializerCommon {
	...
	public void onPreInitEvent(final ProxyModBase proxy) {
