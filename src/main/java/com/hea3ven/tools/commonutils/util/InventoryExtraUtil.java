...
public class InventoryExtraUtil {
    ...
    public static void serialize(CompoundTag tag, DefaultedList<ItemStack> inventory,
            String tagName) {
    ...
    public static void deserialize(CompoundTag tag, DefaultedList<ItemStack> inventory,
            String tagName) {
